...
describe("libnut keyboard action", () => {
    ...
    describe("pressKey", () => {
        ...
        it("should treat a list of keys as modifiers + the actual key to press", () => {
            ...
            expect(libnut.keyToggle)
                .toBeCalledWith(libnut_keyboard_class_1.default.keyLookup(key_enum_1.Key.A), "down", [libnut_keyboard_class_1.default.keyLookup(key_enum_1.Key.LeftControl)]);
        });
    ...
    describe("releaseKey", () => {
        ...
        it("should treat a list of keys as modifiers + the actual key to release", () => {
            ...
            expect(libnut.keyToggle).toBeCalledTimes(1);
            expect(libnut.keyToggle)
                .toBeCalledWith(libnut_keyboard_class_1.default.keyLookup(key_enum_1.Key.A), "up", [libnut_keyboard_class_1.default.keyLookup(key_enum_1.Key.LeftControl)]);
        });
    ...
    describe("bugfix #260", () => {
        it("should forward the pressKey call to libnut for 'delete'", () => {
            ...
            const SUT = new libnut_keyboard_class_1.default();
            // WHEN
            SUT.pressKey(key_enum_1.Key.Delete);
            // THEN
            expect(libnut.keyToggle).toBeCalledTimes(1);
        ...
        it("should forward the releaseKey call to libnut for 'delete'", () => {
            ...
            const SUT = new libnut_keyboard_class_1.default();
            // WHEN
            SUT.releaseKey(key_enum_1.Key.Delete);
            // THEN
            expect(libnut.keyToggle).toBeCalledTimes(1);

...
export { AssertClass, ClipboardClass, KeyboardClass, MouseClass, ScreenClass, providerRegistry };
...
export { clipboard, keyboard, mouse, screen, assert, straightTo, up, down, left, right, getWindows, getActiveWindow, loadImage, saveImage, imageResource };
